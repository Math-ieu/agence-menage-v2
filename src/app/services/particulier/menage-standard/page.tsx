...
export const metadata: Metadata = {
  title: "Ménage Standard Casablanca & Rabat | Services d'une Femme de Ménage",
  description: "Service de ménage standard à Casablanca et Rabat. Notre agence de ménage propose des femmes de ménage qualifiées pour un entretien régulier et fiable de votre domicile.",
  alternates: {
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Ménage Standard Agence de Ménage Casablanca et Rabat",
      },
    ],
  },
};
...
export default function MenageStandardPage() {
  const jsonLd = {
    ...
    "description": "Service de ménage standard hebdomadaire pour particuliers à Casablanca et Rabat"
  };
