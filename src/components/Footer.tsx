            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-start gap-3 text-primary-foreground font-bold text-sm lg:text-base">
                ...
                <div className="flex flex-col gap-2">
                  <span><span className="font-black">Bureau Casablanca :</span> 36 boulevard d’anfa, résidence Anafe A, etage 7, Casablanca</span>
                  <span><span className="font-black">Bureau Rabat :</span> Avenue Hassan II, centre commercial Reda, porte G, appt. 49, Rabat</span>
                </div>
              </li>
              <li className="flex items-center gap-3 text-primary-foreground font-bold text-sm lg:text-base">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <div className="flex items-center gap-6">
              ...
              <div className="flex items-center gap-4">
                <a href="https://www.facebook.com/profile.php?id=61586972460164" aria-label="Visiter notre page Facebook" target="_blank" rel="noopener noreferrer" className="bg-primary-foreground/10 p-2.5 rounded-full hover:bg-primary-foreground/20 transition-colors">
                  <Facebook className="w-5 h-5" />
                </a>
                <a href="https://www.instagram.com/agencemenage?igsh=MXBtNmxzNmNwcmdiYg==&amp;utm_source=ig_contact_invite" aria-label="Visiter notre page Instagram" target="_blank" rel="noopener noreferrer" className="bg-primary-foreground/10 p-2.5 rounded-full hover:bg-primary-foreground/20 transition-colors">
                  <Instagram className="w-5 h-5" />
                </a>
                <a href="#" aria-label="Visiter notre page TikTok" className="bg-primary-foreground/10 p-2.5 rounded-full hover:bg-primary-foreground/20 transition-colors">
