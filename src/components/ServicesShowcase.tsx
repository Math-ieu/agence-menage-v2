...
const particulierServices = [
  ...
  },
  {
    ...
    url: "https://www.agencemenage.ma/services/particulier/nettoyage-post-demenagement",
    dotColor: "#F1C40F",
  },
  {
    ...
    url: "https://www.agencemenage.ma/services/particulier/auxiliaire-de-vie",
    dotColor: "#9B59B6",
  },
  {
...
const entrepriseServices = [
  {
    ...
    url: "https://www.agencemenage.ma/services/entreprise/nettoyage-bureaux",
    dotColor: "#2196F3",
  },
  {
    ...
    url: "https://www.agencemenage.ma/services/entreprise/mise-a-disposition",
    dotColor: "#1976D2",
  },
  {
    ...
    url: "https://www.agencemenage.ma/services/entreprise/nettoyage-fin-chantier",
    dotColor: "#E67E22",
  },
  {
    title: "Ménage Post-sinistre",
