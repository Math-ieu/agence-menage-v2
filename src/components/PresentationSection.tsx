                            ...
                            <div className="relative">
                                ...
                                <div className="space-y-3 text-slate-800 text-lg md:text-xl xl:text-2xl leading-tight text-center xl:text-left pt-2">
                                    {isEntreprise ? (
                                        ...
                                        <>
                                            <p>
                                                Bienvenue chez <span className="font-bold">Agence Ménage</span>. Présente à Casablanca, Rabat et dans leurs régions, notre agence est votre partenaire privilégié pour tous vos besoins en propreté et en accompagnement.
                                            </p>
                                            <p>
