                            ...
                            <div className="relative">
                                ...
                                <div className="space-y-3 text-slate-800 text-lg md:text-xl xl:text-2xl leading-tight text-center xl:text-left pt-2">
                                    {isEntreprise ? (
                                        ...
                                        <>
                                            <p>
                                                Bienvenue chez <span className="font-bold">Agence Ménage</span>. Située en plein cœur de Casablanca, sur le Boulevard d'Anfa, notre agence est votre partenaire privilégié pour tous vos besoins en propreté et en accompagnement.
                                            </p>
                                            <p>
